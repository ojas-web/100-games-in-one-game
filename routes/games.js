...
function allGames() { return [...readJson('studioGames.json').map(g => ({ ...g, category: 'Player Studio', tags: ['Player Studio', g.type, 'Community'], multiplayer: g.type === 'multiplayer', instructions: g.description, featured: false, trending: false, isNew: true, controlType: 'tap' })), ...games]; }
